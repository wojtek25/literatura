...
use Gajdaw\LitBundle\Entity\Item;
use Gajdaw\LitBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GajdawLitBundle:Item')->findAll();
     ...
     * @Method("POST")
     * @Template("GajdawLitBundle:Item:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GajdawLitBundle:Item')->find($id);
     ...
     * @Method("PUT")
     * @Template("GajdawLitBundle:Item:edit.html.twig")
     */

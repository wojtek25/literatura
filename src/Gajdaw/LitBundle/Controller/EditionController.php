...
use Gajdaw\LitBundle\Entity\Edition;
use Gajdaw\LitBundle\Form\EditionType;
...
class EditionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GajdawLitBundle:Edition')->findAll();
     ...
     *
     * @Route("/", name="edition_create")
     * @Method("POST")
     * @Template("GajdawLitBundle:Edition:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GajdawLitBundle:Edition')->find($id);
     ...
     *
     * @Route("/{id}", name="edition_update")
     * @Method("PUT")
     * @Template("GajdawLitBundle:Edition:edit.html.twig")
     */
